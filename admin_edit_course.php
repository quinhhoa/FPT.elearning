...
<head>
  <meta charset="UTF-8" />
  <title>Admin - Cập nhật khóa học</title>
  ...
  <style>
    ...
    .form-group.items-start { align-items: flex-start; }
...
<body class="bg-[#F7F7F7] flex min-h-screen overflow-x-hidden text-[12px]">
  ...
  <div class="flex-1 ml-[200px] flex flex-col min-h-screen">
    <header class="h-12 bg-white border-b border-[#D9DEE4] flex justify-between items-center px-4 z-40 sticky top-0">
      ...
      <div class="flex items-center gap-2 cursor-pointer hover:bg-gray-50 px-2 py-1.5 rounded">
        ...
        <span class="text-xs font-medium">Nguyễn Bá Bình</span>
    ...
    <main class="p-4 flex-1">
      ...
      <div class="bg-white rounded shadow-sm border border-[#E6E9ED]">
        <div class="px-4 py-3 border-b border-[#E6E9ED] flex items-center gap-2 text-[#2A3F54] font-bold text-[13px]">
            <i class="fa-solid fa-edit"></i> Cập nhật khóa học
        </div>
        ...
        <div class="p-6">
            <form action="api/update_course.php" method="POST">
                <!-- ID khóa học được ẩn đi để submit -->
                ...
                <div id="tab-chung" class="max-w-4xl block">
                    <div class="form-group">
                        ...
                        <div class="form-control">
                            <select name="category_id" id="course-category" class="w-full border border-gray-300 px-3 py-1.5 focus:border-[#337AB7] outline-none text-gray-600 rounded-sm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control">
                            <select name="course_type" class="w-full border border-gray-300 px-3 py-1.5 focus:border-[#337AB7] outline-none text-gray-600 rounded-sm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control">
                            <select name="registration_type" id="course-reg-type" class="w-full border border-gray-300 px-3 py-1.5 focus:border-[#337AB7] outline-none text-gray-600 rounded-sm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control">
                            <input type="text" name="course_code" id="course-code" required class="w-full border border-gray-300 px-3 py-1.5 focus:border-[#337AB7] outline-none text-gray-600 rounded-sm">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control">
                            <input type="text" name="title" id="course-title" placeholder="Tên khóa học" required class="w-full border border-gray-300 px-3 py-1.5 focus:border-[#337AB7] outline-none text-gray-600 rounded-sm">
                        </div>
                    </div>

                    <div class="form-group items-start">
                        <label class="form-label mt-2">Thông tin mô tả:</label>
                        <div class="form-control border border-gray-300 rounded-sm">
                            ...
                            <textarea name="description" id="course-desc" rows="5" class="w-full p-3 outline-none text-gray-600 resize-y" placeholder="Nhập mô tả khóa học..."></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group items-start">
                        ...
                        <div class="form-control flex gap-4">
                            <div class="flex-1 space-y-2">
                                <input type="text" name="thumbnail_url" id="course-thumb" placeholder="Dán link ảnh (https://...)" class="w-full border border-gray-300 px-3 py-1.5 focus:border-[#337AB7] outline-none text-gray-600 rounded-sm">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control flex items-center gap-4">
                            <input type="number" name="students" id="course-students" value="0" class="w-32 border border-gray-300 px-3 py-1.5 focus:border-[#337AB7] outline-none text-gray-600 rounded-sm">
                        </div>
                    </div>
                    ...
                    <!-- Bổ sung khối Checkbox Trạng thái Duyệt -->
                    <div class="form-group">
                        <label class="form-label">Duyệt khóa học:</label>
                        <div class="form-control">
                            <input type="checkbox" name="status" id="course-status" value="1" class="mt-1 accent-[#1ABB9C] cursor-pointer"> 
                            <span class="text-gray-500 ml-2 text-[11px]">(Tích để duyệt và hiển thị cho học viên)</span>
                        </div>
                    </div>
                ...
                <div id="tab-dkthamgia" class="max-w-4xl hidden">
                    <div class="form-group">
                        ...
                        <div class="form-control">
                            <select name="condition_exam_id" id="course-cond-exam" class="w-full border border-gray-300 px-3 py-1.5 focus:border-[#337AB7] outline-none text-gray-600 rounded-sm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control">
                            <select name="condition_course_id" id="course-cond-course" class="w-full border border-gray-300 px-3 py-1.5 focus:border-[#337AB7] outline-none text-gray-600 rounded-sm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control">
                            <select name="condition_survey_id" id="course-cond-survey" class="w-full border border-gray-300 px-3 py-1.5 focus:border-[#337AB7] outline-none text-gray-600 rounded-sm">
                ...
                <div id="tab-dkhoanthanh" class="max-w-4xl hidden">
                    <div class="form-group border-b-0">
                        ...
                        <div class="form-control flex items-center gap-3">
                            <input type="number" name="required_learning_time" id="course-req-time" value="0" class="w-32 border border-gray-300 px-3 py-1.5 focus:border-[#337AB7] outline-none text-gray-600 rounded-sm">
                ...
                <div class="border-t border-gray-200 mt-6 pt-4 flex gap-2">
                    ...
                    <div class="w-9/12 flex gap-2">
                        <button type="submit" class="bg-[#1ABB9C] text-white px-5 py-1.5 rounded flex items-center gap-1.5 hover:bg-[#159a80] border border-[#169F85] shadow-sm">
                            <i class="fa-solid fa-check"></i> Cập nhật
                        </button>
                        <button type="button" onclick="location.href='admin.php'" class="bg-[#e2e2e2] text-gray-600 px-5 py-1.5 rounded border border-gray-300 hover:bg-gray-300 transition shadow-sm">
                            Hủy bỏ
                        </button>
                    </div>
                </div>
  ...
  <script>
    ...
    async function loadCourseDetail() {
        ...
        try {
            // TẬN DỤNG FILE get_courses.php ĐỂ TÌM KHÓA HỌC
            const res = await fetch(`api/get_courses.php?view=admin`);
            const courses = await res.json();
            
            // Lọc ra khóa học đang chỉnh sửa
            const data = courses.find(c => c.id == id);

            if(!data) {
                alert("Không tìm thấy khóa học trong CSDL!");
                return;
            }

            // Đổ dữ liệu text
            document.getElementById('course-id').value = data.id;
            document.getElementById('course-code').value = data.course_code || '';
            document.getElementById('course-title').value = data.title || '';
            document.getElementById('course-desc').value = data.description || '';
            document.getElementById('course-thumb').value = data.thumbnail_url || '';
            document.getElementById('course-students').value = data.students || 0;
            document.getElementById('course-req-time').value = data.required_learning_time || 0;
            
            if(data.condition_exam_id) document.getElementById('course-cond-exam').value = data.condition_exam_id;
            if(data.condition_course_id) document.getElementById('course-cond-course').value = data.condition_course_id;
            if(data.condition_survey_id) document.getElementById('course-cond-survey').value = data.condition_survey_id;
            
            if(data.category_id) document.getElementById('course-category').value = data.category_id;
            if(data.registration_type) document.getElementById('course-reg-type').value = data.registration_type;

            // Xử lý Checkbox Duyệt khóa học
            if(document.getElementById('course-status')) {
                document.getElementById('course-status').checked = (data.status == 1);
            }

            // Xử lý tách chuỗi Thời gian học để nạp vào đúng Form Input
            if (data.time_range) {
                if (data.time_range.includes('ngày')) {
                    document.getElementById('time_type_days').checked = true;
                    document.getElementById('course-duration').value = parseInt(data.time_range) || 0;
                } else if (data.time_range.includes('-')) {
                    document.getElementById('time_type_range').checked = true;
                    let dates = data.time_range.split(' - '); 
                    if (dates.length === 2) {
                       let startParts = dates[0].split('/');
                       let endParts = dates[1].split('/');
                       if(startParts.length === 3) document.getElementById('course-start').value = `${startParts[2]}-${startParts[1]}-${startParts[0]}`;
                       if(endParts.length === 3) document.getElementById('course-end').value = `${endParts[2]}-${endParts[1]}-${endParts[0]}`;
                    }
                } else {
                    document.getElementById('time_type_days').checked = true;
                }
            ...
            // Gọi hàm để ẩn/hiện UI tùy theo option được chọn
            toggleTimeInput();
    ...
    function toggleTimeInput() {
        const selectedRadio = document.querySelector('input[name="time_type"]:checked');
        ...
        if (selectedType === 'days') {
            ...
            inputDays.classList.add('block');
            inputRange.classList.add('hidden');
            inputRange.classList.remove('block');
        } else {
            inputDays.classList.add('hidden');
            inputDays.classList.remove('block');
            inputRange.classList.remove('hidden');
            inputRange.classList.add('block');
        }
    }

    // Tự động gọi dữ liệu ngay khi tải trang
